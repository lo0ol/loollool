 ...
 *
 * @par Description
 * This file is a drive for loollool rj25 port.
 *
 * @par Method List:
 *
 ...
 */
LOOL_Port::LOOL_Port(uint8_t port)
{
 ...
 *   slot - SLOT1 or SLOT2
 */
LOOL_Port::LOOL_Port(uint8_t port, uint8_t slot)
{
  s1 = lool_Port[port].s1;
  s2 = lool_Port[port].s2;
  _port = port;
 ...
 *   None
 */
uint8_t LOOL_Port::getSlot(void)
{
  return(_slot);
}
 ...
 *   None
 */
bool LOOL_Port::dRead1(uint8_t mode)
{
  bool val;
  pinMode(s1, mode);
  val = digitalRead(s1);
 ...
 *   None
 */
bool LOOL_Port::dRead2(uint8_t mode)
{
  bool val;
  pinMode(s2, mode);
  val = digitalRead(s2);
 ...
 *   None
 */
void LOOL_Port::dWrite1(bool value)
{
  pinMode(s1, OUTPUT);
 ...
 *   None
 */
void LOOL_Port::dWrite2(bool value)
{
  pinMode(s2, OUTPUT);
 ...
 *   None
 */
void LOOL_Port::aWrite1(int16_t value)
{
 ...
 *   None
 */
void LOOL_Port::aWrite2(int16_t value)
{
 ...
 *   None
 */
void LOOL_Port::reset(uint8_t port)
{
  s1 = lool_Port[port].s1;
  s2 = lool_Port[port].s2;
  _port = port;
 ...
 *   None
 */
void LOOL_Port::reset(uint8_t port, uint8_t slot)
{
  s1 = lool_Port[port].s1;
  s2 = lool_Port[port].s2;
  _port = port;
 ...
 *   None
 */
uint8_t LOOL_Port::pin(uint8_t port, uint8_t slot)
{
  return(slot == SLOT_1 ? lool_Port[port].s1 : lool_Port[port].s2);
}
