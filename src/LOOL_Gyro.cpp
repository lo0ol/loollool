 ...
 * @class   LOOL_Gyro
 * @brief    Driver for LOOL Gyro module.
 * @file    LOOL_Gyro.cpp
 * @author  sean
 * @version V1.0.0
 * @date    2015/11/18
 ...
 *
 * @par Description
 * This file is a drive for LOOL Gyro module, It supports LOOL Gyro V1.0 device provided
 * by loollool.
 *
 * @par Method List:
 *
 *    1. void LOOL_Gyro::setpin(uint8_t AD0, uint8_t INT)
 *    2. void LOOL_Gyro::begin(void)
 *    3. void LOOL_Gyro::update(void)
 *    4. double LOOL_Gyro::getAngleX(void)
 *    5. double LOOL_Gyro::getAngleY(void)
 *    6. double LOOL_Gyro::getAngleZ(void)
 *
 * @par History:
 * <pre>
...
/* Private variables ---------------------------------------------------------*/
volatile uint8_t LOOL_Gyro::_AD0 = 0;
volatile uint8_t LOOL_Gyro::_INT = 0;

/* Private functions ---------------------------------------------------------*/
#ifdef LOOL_PORT_DEFINED
/**
 * Alternate Constructor which can call your own function to map the LOOL_Gyro to arduino port,
 * no pins are used or initialized here
 */
LOOL_Gyro::LOOL_Gyro(void) : LOOL_Port(0)
{
 ...
 */
LOOL_Gyro::LOOL_Gyro(uint8_t port) : LOOL_Port(port)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
}
 ...
 */
LOOL_Gyro::LOOL_Gyro(uint8_t port, uint8_t address) : LOOL_Port(port)
{
 ...
 */
LOOL_Gyro::LOOL_Gyro(uint8_t AD0, uint8_t INT)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
  _AD0 = AD0;
  _INT = INT;
 ...
 *   address - the i2c address you want to set
 */
LOOL_Gyro::LOOL_Gyro(uint8_t AD0, uint8_t INT, uint8_t address)
{
  Device_Address = address;
  _AD0 = AD0;
  _INT = INT;
 ...
 */
void LOOL_Gyro::setpin(uint8_t AD0, uint8_t INT)
{
  _AD0 = AD0;
  _INT = INT;
#ifdef LOOL_PORT_DEFINED
 ...
 */
double LOOL_Gyro::getAngleX(void)
{
  return gx;
}
 ...
 */
double LOOL_Gyro::getAngleY(void)
{
  return gy;
}
 ...
 */
double LOOL_Gyro::getAngleZ(void)
{
  return gz;
}
 ...
 *   Z-axis angle value is integral of Z-axis angular velocity.
 */
double LOOL_Gyro::getAngle(uint8_t index)
{
  if(index == 1)
  {
    return gx;
 ...
 *   deviceCalibration
 * @par Description
 *   Calibration function for the LOOL_Gyro. 
 * param[in]
 *   None
 * @par Output
 *   None
 ...
 */
void LOOL_Gyro::deviceCalibration(void)
{
  int8_t return_value;
  uint16_t x, num = 500;
 ...
 */
int8_t LOOL_Gyro::writeReg(int16_t reg, uint8_t data)
{
 ...
 */
int8_t LOOL_Gyro::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
 ...
 */
int8_t LOOL_Gyro::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
