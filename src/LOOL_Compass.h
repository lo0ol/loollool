 ...
 * @version V1.0.0
 * @date    2015/11/18
 * @brief   Header for Compass module.
 *
 * @par Copyright
 ...
 *
 * @par Description
 * This file is a drive for Compass module, It supports LOOL Compass V1.0 device provided
 * by loollool.
 *
 * @par Method List:
 *
...
#ifndef LOOL_COMPASS_H
#define LOOL_COMPASS_H
 ...
 * Class: LOOL_Compass
 * @par Description
 * Declaration of Class LOOL_Compass
 */
#ifndef LOOL_PORT_DEFINED
class LOOL_Compass
#else // !LOOL_PORT_DEFINED
class LOOL_Compass : public LOOL_Port
#endif // !LOOL_PORT_DEFINED
{
public:
#ifdef LOOL_PORT_DEFINED
 ...
 */
  LOOL_Compass(uint8_t port, uint8_t address);
#else
/**
 ...
 */
  LOOL_Compass(uint8_t keyPin, uint8_t ledPin);
 ...
 *   address - the i2c address you want to set
 */
  LOOL_Compass(uint8_t keyPin, uint8_t ledPin, uint8_t address);
#endif  //  LOOL_PORT_DEFINED
/**
 * @par Function
 *   setpin
