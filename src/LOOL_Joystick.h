 ...
 * @version V1.0.0
 * @date    2015/11/18
 * @brief   Header for LOOL Joystick module
 *
 * @par Copyright
 ...
 *
 */
#ifndef LOOL_Joystick_H
#define LOOL_Joystick_H
 ...
 * Class: LOOL_Joystick
 * par Description
 * Declaration of Class LOOL_Joystick.
 */
#ifndef LOOL_PORT_DEFINED
class LOOL_Joystick
#else // !LOOL_PORT_DEFINED
class LOOL_Joystick : public LOOL_Port
#endif
{
  public:
#ifdef LOOL_PORT_DEFINED
 ...
 */
    LOOL_Joystick(uint8_t x_port,uint8_t y_port);
#endif  // LOOL_PORT_DEFINED
