 ...
 * @version V1.0.0
 * @date    2015/11/18
 * @brief   Header for LOOL Gyro  module.
 *
 * @par Copyright
 ...
 * Class: LOOL_Gyro
 * @par Description
 * Declaration of Class LOOL_Gyro
 */
#ifndef LOOL_PORT_DEFINED
class LOOL_Gyro
#else // !LOOL_PORT_DEFINED
class LOOL_Gyro : public LOOL_Port
#endif // !LOOL_PORT_DEFINED
{
public:
#ifdef LOOL_PORT_DEFINED
 ...
 */
  LOOL_Gyro(uint8_t port, uint8_t address);
#else
/**
 ...
 */
  LOOL_Gyro(uint8_t AD0, uint8_t INT);
 ...
 *   address - the i2c address you want to set
 */
  LOOL_Gyro(uint8_t AD0, uint8_t INT, uint8_t address);
#endif  //  LOOL_PORT_DEFINED
/**
 * @par Function
 *   setpin
