 ...
 * @file    LOOL_7SegmentDisplay.cpp
 * @author  sean
 * @version V1.0.0
 * @date    2015/11/18
 * @brief   Driver for 7 Segment Serial Display module.
 *
 * @par Copyright
 ...
 *   None
 */
LOOL_7SegmentDisplay::LOOL_7SegmentDisplay(void) : LOOL_Port()
{
 ...
 */
LOOL_7SegmentDisplay::LOOL_7SegmentDisplay(uint8_t port) : LOOL_Port(port)
{
  _dataPin = s1;
  _clkPin = s2;
 ...
 */
LOOL_7SegmentDisplay::LOOL_7SegmentDisplay(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
  pinMode(_clkPin, OUTPUT);
 ...
 */
void LOOL_7SegmentDisplay::reset(uint8_t port)
{
  _port = port;
 ...
 */
void LOOL_7SegmentDisplay::setpin(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
  pinMode(_clkPin, OUTPUT);
 ...
 * @par Others
 */
void LOOL_7SegmentDisplay::clearDisplay(void)
{
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  display(buf);
}
 ...
 *    None
 */
void LOOL_7SegmentDisplay::init(void)
{
  clearDisplay();
}
 ...
 *    None
 */
void LOOL_7SegmentDisplay::writeByte(uint8_t wr_data)
{
  uint8_t i;
  uint8_t cnt0;
 ...
 *    None
 */
void LOOL_7SegmentDisplay::start(void)
{
 ...
 *    None
 */
void LOOL_7SegmentDisplay::stop(void)
{
  digitalWrite(_clkPin, LOW);
  digitalWrite(_dataPin, LOW);
  digitalWrite(_clkPin, HIGH);
 ...
 *    None
 */
void LOOL_7SegmentDisplay::write(uint8_t SegData[])
{
  uint8_t i;
 ...
 *    None
 */
void LOOL_7SegmentDisplay::write(uint8_t BitAddr, uint8_t SegData)
{
  start();    // start signal sent to TM1637 from MCU
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(uint16_t value)
{
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(int16_t value)
{
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(float value)
{
  uint8_t i=0;
  bool isStart = false;
  uint8_t index = 0;
 ...
 *    None
 */
int16_t LOOL_7SegmentDisplay::checkNum(float v,int16_t b)
{
  if(b>=0)
  {
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(double value, uint8_t digits)
{
Posotion_1:
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  uint8_t tempBuf[4];
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(uint8_t DispData[])
{
  uint8_t SegData[4];
  uint8_t i;
  for (i = 0; i < 4; i++)
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(uint8_t DispData, uint8_t BitAddr)
{
  uint8_t SegData;
 ...
 *    None
 */
void LOOL_7SegmentDisplay::display(uint8_t DispData, uint8_t BitAddr, uint8_t point_on)
{
  uint8_t SegData;
 ...
 *    None
 */
void LOOL_7SegmentDisplay::set(uint8_t brightness, uint8_t SetData, uint8_t SetAddr)
{
  Cmd_SetData = SetData;
  Cmd_SetAddr = SetAddr;
 ...
 *    None
 */
void LOOL_7SegmentDisplay::setBrightness(uint8_t brightness)
{
 ...
 *    None
 */
void LOOL_7SegmentDisplay::coding(uint8_t DispData[])
{
 ...
 *    None
 */
uint8_t LOOL_7SegmentDisplay::coding(uint8_t DispData)
{
