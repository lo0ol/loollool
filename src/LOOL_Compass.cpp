 ...
 * @par Method List:
 *
 *    1. void LOOL_Compass::setpin(uint8_t keyPin, uint8_t ledPin)
 *    2. void LOOL_Compass::begin(void)
 *    3. bool LOOL_Compass::testConnection(void)
 *    4. double LOOL_Compass::getAngle(void)
 *    5. int16_t LOOL_Compass::getHeadingX(void)
 *    6. int16_t LOOL_Compass::getHeadingY(void)
 *    7. int16_t LOOL_Compass::getHeadingZ(void)
 *    8. int16_t LOOL_Compass::getHeading(int16_t *x, int16_t *y, int16_t *z)
 *
 * @par History:
 * <pre>
...
/* Private variables ---------------------------------------------------------*/
volatile uint8_t LOOL_Compass::_keyPin = 0;
volatile uint8_t LOOL_Compass::_ledPin = 0;
 ...
 */
LOOL_Compass::LOOL_Compass() : LOOL_Port(0)
{
 ...
 */
LOOL_Compass::LOOL_Compass(uint8_t port) : LOOL_Port(port)
{
  Device_Address = COMPASS_DEFAULT_ADDRESS;
  Calibration_Flag = false;
}
 ...
 */
LOOL_Compass::LOOL_Compass(uint8_t port, uint8_t address) : LOOL_Port(port)
{
 ...
 */
LOOL_Compass::LOOL_Compass(uint8_t keyPin, uint8_t ledPin)
{
  Device_Address = COMPASS_DEFAULT_ADDRESS;
  Calibration_Flag = false;
  _keyPin = keyPin;
 ...
 *   address - the i2c address you want to set
 */
LOOL_Compass::LOOL_Compass(uint8_t keyPin, uint8_t ledPin, uint8_t address)
{
  Device_Address = address;
  Calibration_Flag = false;
  _keyPin = keyPin;
 ...
 */
void LOOL_Compass::setpin(uint8_t keyPin, uint8_t ledPin)
{
  _keyPin = keyPin;
  _ledPin = ledPin;
#ifdef LOOL_PORT_DEFINED
 ...
 *   testConnection
 * @par Description
 *   Identify the device whether is the LOOL_Compass.
 * param[in]
 *   None
 * @par Output
 *   None
 ...
 */
bool LOOL_Compass::testConnection(void)
{
 ...
 * @par Others
 *   Will return a correct angle when you keep the LOOL_Compass working in the plane which have calibrated.
 */
double LOOL_Compass::getAngle(void)
{
  int16_t cx,cy,cz;
 ...
 */
int16_t LOOL_Compass::getHeadingX(void)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 *   The sensor value is a 16 bits signed integer.
 */
int16_t LOOL_Compass::getHeadingY(void)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 *   The sensor value is a 16 bits signed integer.
 */
int16_t LOOL_Compass::getHeadingZ(void)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 */
int16_t LOOL_Compass::getHeading(int16_t *x, int16_t *y, int16_t *z)
{
  int8_t return_value = 0;
  deviceCalibration();
 ...
 */
int8_t LOOL_Compass::writeReg(int16_t reg, uint8_t data)
{
  int8_t return_value = 0;
 ...
 */
int8_t LOOL_Compass::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
 ...
 */
int8_t LOOL_Compass::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
  Wire.beginTransmission(Device_Address);
 ...
 *   deviceCalibration
 * @par Description
 *   Calibration function for the LOOL_Compass. 
 * param[in]
 *   None
 * @par Output
 *   None
 ...
 *   rotate the LOOL_Compass over 360 degress in a stable plane that you specified to calibrate,
 *   and press the button again to finish the calibration.
 */
void LOOL_Compass::deviceCalibration(void)
{
#ifdef LOOL_PORT_DEFINED
 ...
 */
void LOOL_Compass::read_EEPROM_Buffer(void)
{
 ...
 *   Call the arduino official EEPROM library.
 */
void LOOL_Compass::write_EEPROM_Buffer(struct Compass_Calibration_Parameter *parameter_pointer)
{
