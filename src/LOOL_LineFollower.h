 ...
 * @file    LOOL_LineFollower.h
 * @author  sean
 * @version V1.0.0
 * @date    2015/09/07
 * @brief   Header for for LOOL_LineFollower.cpp module
 *
 * @par Copyright
 ...
 *
 */
#ifndef LOOL_LineFollower_H
#define LOOL_LineFollower_H
 ...
 * Class: LOOL_LineFollower
 * @par Description
 * Declaration of Class LOOL_LineFollower.
 */
#ifndef LOOL_PORT_DEFINED
class LOOL_LineFollower
#else // !LOOL_PORT_DEFINED
class LOOL_LineFollower : public LOOL_Port
#endif  // LOOL_PORT_DEFINED
{
public:
#ifdef LOOL_PORT_DEFINED
 ...
 */
  LOOL_LineFollower(uint8_t port);
#else // LOOL_PORT_DEFINED 
/**
 * Alternate Constructor which can call your own function to map the line follwer device to arduino port,
 ...
 */
  LOOL_SoundSensor(uint8_t Sensor1,uint8_t Sensor2);
#endif  // LOOL_PORT_DEFINED
/**
 * @par Function
 *   setpin
