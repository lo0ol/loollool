...
#ifndef LOOL_USBHost_H
#define LOOL_USBHost_H
#include <Arduino.h>
#include <stdint.h>
#include <stdbool.h>
...
class LOOL_USBHost : public LOOL_Port
{
    public:
      bool ch375_online;
      bool device_online;
      ...
      LOOL_USBHost();
      //LOOL_USBHost(uint8_t s1, uint8_t s2);
      LOOL_USBHost(uint8_t port);
